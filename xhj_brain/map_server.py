...
class compareHandler(tornado.web.RequestHandler):
    def post(self):
        ...
        try:
            ...
            # {
            #     "house_lst": [100, 5, 3, 2, 1, 5000, 50, "红星商务楼", "长沙", "南门口"]
            # }
            house_lst = url_json["house_lst"]

            response_dict = {}
            #print(user_lst)
            housr_value = mapping(house_lst)

            response_dict["house  -----> house"] = housr_value
